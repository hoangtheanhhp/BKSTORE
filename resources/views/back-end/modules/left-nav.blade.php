<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active"><a href="{!!url('admin/home/')!!}">
                ...
                Trang chủ</a></li>
        <li id="danhmuc"><a href="{!!url('admin/danhmuc')!!}">
                <svg class="glyph stroked clipboard with paper">
                    <use xlink:href="#stroked-clipboard-with-paper"/>
                </svg>
                Danh mục</a></li>

        <li id="sanpham"><a href="{!!url('admin/sanpham/all')!!}">
        ...
        <li><a href="{!!url('admin/khachhang')!!}">
                ...
                Khách hàng</a></li>
        <li><a href="{!!url('admin/slide')!!}"><span class="glyphicon glyphicon-film"></span> Slide</a></li>
